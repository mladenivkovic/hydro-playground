...
\usepackage{xspace}
\newcommand{\codename}[1]{\textsc{#1}\xspace}
\newcommand{\hydro}{\codename{hydro-playground}}
\newcommand{\cmake}{\codename{cmake}}
\newcommand{\mhutils}{\codename{mesh\_hydro\_utils}}
\newcommand{\jargon}[1]{\texttt{#1}\xspace}
