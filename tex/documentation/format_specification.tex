...
\note{
    ...
    \verb|hydro_playground/examples/example_paramfile.txt|.
}
...
%
% % ---------------------------------------
% \subsubsection{Source Term Parameters}
% % ---------------------------------------
%
% \begin{tabular}[c]{p{2.5cm} p{1.5cm} p{1.cm} p{9.cm}}
% Name & Default & Type & Description \\
