...
inline size_t Parameters::getNstepsLog() const {
  return _nstepsLog;
}


inline void Parameters::setNstepsLog(const size_t nstepsLog) {
...
inline int Parameters::getVerbose() const {
  return _verbose;
}


inline void Parameters::setVerbose(const int verbose) {
  _verbose = verbose;
  paramSetLog(verbose);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline size_t Parameters::getNsteps() const {
  return _nsteps;
}


inline void Parameters::setNsteps(const size_t nsteps) {
  _nsteps = nsteps;
  paramSetLog(nsteps);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline Float Parameters::getTmax() const {
  return _tmax;
}


inline void Parameters::setTmax(const Float tmax) {
  _tmax = tmax;
  paramSetLog(tmax);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline size_t Parameters::getNx() const {
  return _nx;
}


inline void Parameters::setNx(const size_t nx) {
  _nx = nx;
  paramSetLog(nx);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline Float Parameters::getCcfl() const {
  return _ccfl;
}


inline void Parameters::setCcfl(const Float ccfl) {
  _ccfl = ccfl;
  paramSetLog(ccfl);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline BC::BoundaryCondition Parameters::getBoundaryType() const {
  return _boundary_type;
}


inline void Parameters::setBoundaryType(BC::BoundaryCondition boundary_type) {
...
inline size_t Parameters::getNBC() const {
  return _nbc;
}


inline void Parameters::setNBC(const size_t nbc) {
  _nbc = nbc;
  paramSetLog(nbc);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline size_t Parameters::getReplicate() const {
  return _replicate;
}


inline void Parameters::setReplicate(const size_t replicate) {
...
inline bool Parameters::getWriteReplications() const {
  return _write_replications;
}


inline void Parameters::setWriteReplications(const bool writeReplications) {
...
inline std::string Parameters::getOutputFileBase() const {
  return _outputfilebase;
}


inline void Parameters::setOutputFileBase(std::string& ofname) {
...
inline size_t Parameters::getFoutput() const {
  return _foutput;
}


inline void Parameters::setFoutput(const size_t foutput) {
  _foutput = foutput;
  paramSetLog(foutput);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline Float Parameters::getDtOut() const {
  return _dt_out;
}


inline void Parameters::setDtOut(const Float dt_out) {
  _dt_out = dt_out;
  paramSetLog(dt_out);
#if DEBUG_LEVEL > 0
  if (_locked)
...
inline bool Parameters::getParamFileHasBeenRead() const {
  return _read;
}


inline void Parameters::setParamFileHasBeenRead() {
  _read = true;
}


inline Float Parameters::getBoxsize() const {
  return _boxsize;
}


inline void Parameters::setBoxsize(const Float boxsize) {
  _boxsize = boxsize;
}
