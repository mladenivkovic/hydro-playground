...
There are tricks how to obtain different kinds of boundary conditions. In every
...
% This is valid for the Euler equations, but not for linear advection. In fact,
% having reflecting boundary conditions for constant linear advection doesn't
% really make sense.
